...
REQD_PERMISSIONS = "https://GitHub.com/changaniashish"
GIT_REPO_LINK = "https://t.me/Aashish_Changani"
...
START_MESSAGE = get_config("START_MESSAGE", (
    ...
    "\n\n"
    f"To Follow Us on GitHub 👉 {REQD_PERMISSIONS} 👈"
    "\n\n"
    f"In If case of issues, contact 👉 {GIT_REPO_LINK} 👈"
))
